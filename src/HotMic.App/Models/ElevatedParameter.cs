...
public static class ElevatedParameterDefinitions
{
    public static readonly Dictionary<string, (int Index, string Name)[]> PluginElevations = new()
    {
        ...
        ["builtin:eq3"] = [(3, "Low-Mid Gain"), (6, "High-Mid Gain")],
        ["builtin:hpf"] = [(0, "Cutoff"), (1, "Slope")],
        ["builtin:deesser"] = [(2, "Threshold"), (3, "Reduction")],
        ["builtin:saturation"] = [(0, "Drive"), (1, "Mix")],
        ["builtin:limiter"] = [(0, "Ceiling"), (1, "Release")],
